  ...
  void sharePost() {
    if (widget.type == 'image' &&
      ...
      ref.read(postControllerProvider.notifier).shareLinkPost(
            ...
            title: titleController.text.trim(),
            selectedCommunity: selectedCommunity ?? communities[0],
            link: _sanitizeUrl(linkController.text.trim()),
          );
    } else {
                  ...
                  child: Column(
                    children: [
                            ...
                            if (linkController.text.trim().isNotEmpty)
                              AnyLinkPreview(
                                ...
                                errorWidget: Padding(
                                  ...
                                  child: Text(
                                    _sanitizeUrl(linkController.text.trim()),
                                ...
                                errorBody:
                                    "unable to load!!!", // No error message, just fallback to link
                      ...
                      ref.watch(userCommunitiesProvider).when(
                            data: (data) {
                              communities = data.cast<Community>();

                              if (communities.isEmpty) {
                                return const Text('Join a community to post!');
                              }
